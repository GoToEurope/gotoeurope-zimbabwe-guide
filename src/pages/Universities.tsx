...
const Universities = () => {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="relative py-32 px-4 bg-cover bg-center bg-no-repeat" style={{
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl bg-zinc-100">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {universities.map((university, index) => <Card key={index} className="hover:shadow-lg transition-shadow duration-300 bg-white">
